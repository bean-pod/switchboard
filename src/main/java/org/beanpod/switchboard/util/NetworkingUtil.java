...
public class NetworkingUtil {
    ...
    public boolean areDevicesOnSameLocalNetworkAsService(DeviceDto firstDevice, DeviceDto secondDevice) {
        return isDeviceOnSameLocalNetworkAsService(firstDevice) && isDeviceOnSameLocalNetworkAsService(secondDevice);
    }
}
