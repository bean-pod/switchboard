...
const firstStreamResponse = StreamFixture.firstStreamResponse;
const secondStreamResponse = StreamFixture.secondStreamResponse;
const allStreamsResponse = StreamFixture.allStreamsResponse;
